{-
    Description: An Hamiltonian cycle is a path X1 . . . Xn such that X1 = Xn and X2 . . . Xn is Hamiltonian.
    An Hamiltonian path, oth, is a graph with nodes only visited once.
-}
